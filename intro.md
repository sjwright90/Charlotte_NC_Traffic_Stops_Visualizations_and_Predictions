...
This interactive app allows users to develop plots from a dataset of police stops in the City of Charlotte, NC. The app alse hosts a decision tree classifier that predicts the outcome of a traffic stop given user inputs.
